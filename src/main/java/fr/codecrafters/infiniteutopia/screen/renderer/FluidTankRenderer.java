package fr.codecrafters.infiniteutopia.screen.renderer;
...
public class FluidTankRenderer {
    ...
    public java.util.List<Component> getTooltip(FluidStack fluidStack, TooltipFlag tooltipFlag) {
        ...
        try {
            ...
            net.minecraft.network.chat.Component displayName = fluidStack.getDisplayName();
            ...
            if (tooltipMode == TooltipMode.SHOW_AMOUNT_AND_CAPACITY) {
                MutableComponent amountString = net.minecraft.network.chat.Component.translatable("infinite_utopia.tooltip.liquid.amount.with.capacity", nf.format(milliBuckets), nf.format(capacity));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            } else if (tooltipMode == TooltipMode.SHOW_AMOUNT) {
                MutableComponent amountString = net.minecraft.network.chat.Component.translatable("infinite_utopia.tooltip.liquid.amount", nf.format(milliBuckets));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            }
