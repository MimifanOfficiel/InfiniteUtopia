...
import fr.codecrafters.infiniteutopia.screen.slot.ResultSlots;
...
public class CookingPotMenu extends AbstractContainerMenu {
    ...
    public CookingPotMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        super(MenuTypes.COOKING_POT_MENU.get(), pContainerId);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 26, 16));
            this.addSlot(new SlotItemHandler(handler, 1, 44, 16));
            this.addSlot(new SlotItemHandler(handler, 2, 62, 16));
            this.addSlot(new SlotItemHandler(handler, 3, 26, 34));
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, BlocksManager.COOKING_POT.get());
    }
